      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex items-center gap-4">
            <div className="w-1/3">
              <Image
                src="https://images.pexels.com/photos/5414817/pexels-photo-5414817.jpeg?auto=compress&cs=tinysrgb&w=1200kk"
                alt=""
                width={144}
                height={144}
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold">Bess Mills</h1>
                <FormModal
                  table="student"
                  type="update"
                  data={{
                    ...
                    sex: "female",
                    img: "https://images.pexels.com/photos/5414817/pexels-photo-5414817.jpeg?auto=compress&cs=tinysrgb&w=1200kk",
                  }}
                />
              </div>
              <p className="text-sm text-gray-500">
                history clean show liquid fully horse duck guess sick process
                someone per available handsome environment course calm church
                regular instrument recently pick joy wild
              </p>
